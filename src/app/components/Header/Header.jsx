...
const Header = ({ city, openCityModal }) => {
  ...
  return (
    <header className={`${'container'} ${styles.header}`}>
      <button className={styles.btn} onClick={() => setShowNavigation(!showNavigation)}>
      ...
      <ul className={showNavigation ? styles.btnListNav : styles.btnList}>
        ...
        <li className={styles.btnList__item}>
          {token ? (
            ...
            <Link href="/loginPage" className={styles.login}>
              <svg
                className={styles.btnList__icon}
                xmlns="http://www.w3.org/2000/svg"
                width="21"
        ...
        <li className={styles.btnList__item}>
          <button className={styles.btnList__btn}>
            ...
            <span className={styles.btnList__text}>Улюблене</span>
          </button>
        </li>
        <li className={styles.btnList__item}>
          <Link href="/cartPage" className={styles.btnList__btn}>
            ...
            <span className={styles.btnList__text}>Корзина</span>
          </Link>
          <Link href="/addLaisurePage" className={styles.buttonAddActivity}>
            Пропоную дозвілля
          </Link>
        </li>
      </ul>
